...
<div class="bg-white rounded-xl shadow-lg p-6">
  <div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-semibold text-[#1E3A8A]">Data User</h2>
...
@endif
  ...
  {{-- Search Manual --}}
  <div class="mb-4">
    <input type="text" id="customSearch" placeholder="🔍 Cari nama, email, atau role..."
  ...
  <div class="overflow-x-auto rounded-xl shadow-inner">
    <table id="tableUser" class="min-w-full text-sm text-gray-800 bg-white border-separate" style="border-spacing: 0">
...
<style>
  ...
  .dataTables_wrapper .dataTables_length {
    margin-bottom: 1rem; /* INI DITAMBAHKAN */
    font-size: 0.875rem;
    color: #4B5563;
  }
